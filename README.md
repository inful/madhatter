...
- **Leave management**: Unified system for sick leave, vacation, and other absences. Each record carries a `leave_type` tag (Leave or Conference) for differentiated UI on the dashboard and management page.
