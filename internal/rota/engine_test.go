...
func TestEngine_AssignCoversForLeave_IgnoresUnscheduledLeave(t *testing.T) {
	...
	leaveID, err := db.CreateLeaveRecord(ctx, bobID, "2024-01-15", "2024-01-15", database.LeaveTypeLeave)
	require.NoError(t, err)
...
func TestEngine_AssignCoversForLeave_MultiDayLeave(t *testing.T) {
	...
	leaveID, err := db.CreateLeaveRecord(ctx, aliceID, "2024-01-17", "2024-01-19", database.LeaveTypeLeave)
	require.NoError(t, err)
...
func TestEngine_AssignCoversForLeave_LeaveOnWeekend(t *testing.T) {
	...
	leaveID, err := db.CreateLeaveRecord(ctx, aliceID, "2024-01-13", "2024-01-14", database.LeaveTypeLeave)
	require.NoError(t, err)
...
func TestEngine_CoverRotationDeterministic(t *testing.T) {
	...
	leaveID1, err := db.CreateLeaveRecord(ctx, aliceID, "2024-01-15", "2024-01-15", database.LeaveTypeLeave)
	require.NoError(t, err)
	err = engine.AssignCoversForLeave(ctx, leaveID1)
	require.NoError(t, err)

	// Alice takes leave again on Friday Jan 19 (also her scheduled day)
	leaveID2, err := db.CreateLeaveRecord(ctx, aliceID, "2024-01-19", "2024-01-19", database.LeaveTypeLeave)
	require.NoError(t, err)
