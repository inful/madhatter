-- Add ON DELETE CASCADE to foreign keys in related tables
-- SQLite requires recreating tables to modify foreign keys

PRAGMA foreign_keys = OFF;

-- Recreate leave_records table with CASCADE
...
-- Recreate rota_assignments table with CASCADE
...
-- Recreate calendar_subscriptions table with CASCADE
